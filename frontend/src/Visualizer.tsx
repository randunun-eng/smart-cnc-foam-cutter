...
export default function Visualizer({ gcode, feedRate }: VisualizerProps) {
    ...
    // Animation Loop
    useEffect(() => {
        let animationFrame: number = 0; // Initialize to 0
        if (isPlaying) {
    ...
    useEffect(() => {
        ...
        path.forEach((p, i) => {
            ...
            else if (i <= drawUntil) ctx.lineTo(sx, sy);
        });
        ctx.stroke();
    ...
    return (
        <div className="flex flex-col gap-2 h-full">
            <div className="flex-1 bg-gray-900 rounded border border-gray-700 relative overflow-hidden">
                <canvas
                    ref={canvasRef}
                    width={400}
                    height={300}
                ...
                />
                <div className="absolute top-2 right-2 bg-black/70 px-2 py-1 rounded text-xs text-gray-400 font-mono">
            ...
            <div className="flex items-center gap-2">
                ...
                <input
                    ...
                    className="flex-1 h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-neon-blue"
                />
